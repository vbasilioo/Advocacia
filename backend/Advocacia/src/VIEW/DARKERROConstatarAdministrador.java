...
public class DARKERROConstatarAdministrador extends javax.swing.JFrame {

    private static final org.slf4j.Logger LOGGER = LoggerFactory.getLogger(Log.class);
    
    public DARKERROConstatarAdministrador() {
        initComponents();
    ...
    private void initComponents() {
        ...
        campoOK.setBackground(new java.awt.Color(51, 51, 51));
        campoOK.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        campoOK.setForeground(new java.awt.Color(153, 153, 153));
        campoOK.setText("OK");
