...
public class CadastProcesso extends javax.swing.JFrame {
    ...
    public CadastProcesso() {
        
        if(CadSelecionarUsuarios.adicionar)
        {
            text+=CadSelecionarUsuarios.id +",";
            System.out.println("id: " +text);
            users.addElement(CadSelecionarUsuarios.id);
            CadSelecionarUsuarios.addUsuarios(false);
        }
        else
        {
            if(!CadSelecionarUsuarios.cancelar)
            {
                text=CredencialDAO.id +",";
                cliente="";
                CadSelecionarUsuarios.setCancelar(false);
            }
        }
        initComponents();
        id=0;
    ...
    private void initComponents() {
        ...
        buttonCadastrar.setBackground(new java.awt.Color(70, 130, 180));
    ...
    private void buttonAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAdicionarActionPerformed
        ...
        CadSelecionarUsuarios su = new CadSelecionarUsuarios();
        su.setVisible(true);
        dispose();
