        ...
        <div class="row">
            ...
            <div class="col-6">
                ...
                <form action="updatePro.php" method="post">
                    ...
                    <input type="text" name="usuario_associado" placeholder="Usuários Associados" required><br><br>
        ...
        <div class="row">
            ...
            <div class="col-5">
                ...
                <?php
                    ...
                    $usuario_associado = $_POST['usuario_associado'];
                            
                    $query = "UPDATE `processos` 
                    SET `cliente`='".$cliente."', `usuario_associado`='".$usuario_associado."' WHERE `id_processo` = $id_processo";
                    
                    $result = mysqli_query($connect, $query);

                    if($result){
                        echo "<div class='alert alert-success' role='alert'>
                                Você obeteve <b>sucesso</b> editando o processo!
                                </div>";
                    }else{
                        echo "<div class='alert alert-danger' role='alert'>
                                Falha ao editar o processo!
                                </div>";
                    }
