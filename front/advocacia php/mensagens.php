...
<div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 220px; height: 760px; color: whitesmoke;">
    ...
    <hr>
    <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-dark text-decoration-none">
      <svg class="bi pe-none me-2" width="15" height="32"><use xlink:href="#bootstrap"></use></svg>
      <span class="fs-10">Bem-vindo ao painel, <b><?php echo $_SESSION['nome_usuario']; ?></b>.</span>
    </a>
    <hr>
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li>
        <a href="mensagens.php" class="nav-link active" aria-current="page">
          <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#table"></use></svg>
          Mensagens
        </a>
      </li>
      <li>
        <a href="arquivos.php" class="nav-link link-dark">
                ...
                <tbody>
                    <?php
                        while($row_usuario = mysqli_fetch_assoc($resultad_usuarios)){
                            echo "<tr>";
                            echo "<td>" . $row_usuario['id_mensagem'] . "</td>";
                            echo "<td>" . $row_usuario['email_usuario'] . "</td>";
                            echo "<td>" . $row_usuario['mensagem_usuario'] . "</td>";
                            echo "<td>
                                    <a href='updateMsg.php'>
